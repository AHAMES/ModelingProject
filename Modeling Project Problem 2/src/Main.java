...
public class Main {
	...
	public static void main(String[] args) {
		...
		JFreeChart barChart2 = ChartFactory.createBarChart("Ordering Stats", "", "Number Of Cars", dataset3,
				PlotOrientation.VERTICAL, true, true, false);
		...
		JFreeChart lineChart = ChartFactory.createLineChart("Storage Usage", "Cycles", "Cars in Storage", dataset4,
				PlotOrientation.VERTICAL, true, true, false);
