...
public class Main {
	...
	public static void main(String args[]) {
		...
		for(int i=0;i<6;i++)
		{
			distributionDataset.addValue(xtTheoreticalAnswer.interArrivalDistribution[i], "Inter-Arrival", i+"");
		}
		for(int i=0;i<4;i++)
		{
			distributionDataset.addValue(xtTheoreticalAnswer.serviceTimeDistribution[i], "Service Time", i+1+"");
		}
